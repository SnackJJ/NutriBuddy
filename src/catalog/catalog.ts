...
export const SEED_FOODS: readonly CatalogFood[] = [
  ...
  },
  {
    ...
    per100g: { kcal: 209, proteinG: 26, fatG: 11, carbsG: 0 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 239, proteinG: 27, fatG: 14, carbsG: 0 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 250, proteinG: 26, fatG: 15, carbsG: 0 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 242, proteinG: 27, fatG: 14, carbsG: 0 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 231, proteinG: 25, fatG: 14, carbsG: 0 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 135, proteinG: 30, fatG: 0.7, carbsG: 0 },
    allergenTags: [],
  ...
  // ── seafood ────────────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 208, proteinG: 20, fatG: 13, carbsG: 0 },
    allergenTags: ["fish"],
  ...
  },
  {
    ...
    per100g: { kcal: 132, proteinG: 28, fatG: 1.3, carbsG: 0 },
    allergenTags: ["fish"],
  ...
  },
  {
    ...
    per100g: { kcal: 85, proteinG: 20, fatG: 0.5, carbsG: 0 },
  ...
  },
  {
    ...
    per100g: { kcal: 82, proteinG: 18, fatG: 0.7, carbsG: 0 },
    allergenTags: ["fish"],
  ...
  // ── grains ─────────────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 130, proteinG: 2.7, fatG: 0.3, carbsG: 28 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 123, proteinG: 2.7, fatG: 1, carbsG: 26 },
    allergenTags: [],
    portionAliases: { bowl: 200, cup: 180, serving: 150 },
    category: "grain",
  },
  {
    ...
    per100g: { kcal: 265, proteinG: 9, fatG: 3.2, carbsG: 49 },
    allergenTags: ["wheat"],
  ...
  },
  {
    ...
    per100g: { kcal: 247, proteinG: 13, fatG: 3.4, carbsG: 41 },
    allergenTags: ["wheat"],
    portionAliases: { slice: 28, piece: 28, serving: 56 },
    category: "grain",
  },
  {
    ...
    per100g: { kcal: 131, proteinG: 5, fatG: 1.1, carbsG: 25 },
    allergenTags: ["wheat"],
  ...
  },
  {
    ...
    per100g: { kcal: 71, proteinG: 2.5, fatG: 1.5, carbsG: 12 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 138, proteinG: 4.5, fatG: 2.1, carbsG: 25 },
    allergenTags: ["wheat"],
  ...
  // ── vegetables ─────────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 34, proteinG: 2.8, fatG: 0.4, carbsG: 7 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 23, proteinG: 2.9, fatG: 0.4, carbsG: 3.6 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 41, proteinG: 0.9, fatG: 0.2, carbsG: 10 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 18, proteinG: 0.9, fatG: 0.2, carbsG: 3.9 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 77, proteinG: 2, fatG: 0.1, carbsG: 17 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 86, proteinG: 1.6, fatG: 0.1, carbsG: 20 },
    allergenTags: [],
  ...
  // ── dairy / eggs ──────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 155, proteinG: 13, fatG: 11, carbsG: 1.1 },
    allergenTags: ["egg"],
  ...
  },
  {
    ...
    per100g: { kcal: 34, proteinG: 3.4, fatG: 0.1, carbsG: 5 },
    allergenTags: ["milk"],
  ...
  },
  {
    ...
    per100g: { kcal: 402, proteinG: 25, fatG: 33, carbsG: 1.3 },
    allergenTags: ["milk"],
  ...
  },
  {
    ...
    per100g: { kcal: 63, proteinG: 5.3, fatG: 1.6, carbsG: 7 },
    allergenTags: ["milk"],
  ...
  },
  {
    ...
    per100g: { kcal: 97, proteinG: 9, fatG: 5, carbsG: 3.6 },
    allergenTags: ["milk"],
  ...
  // ── fruits ─────────────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 89, proteinG: 1.1, fatG: 0.3, carbsG: 23 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 52, proteinG: 0.3, fatG: 0.2, carbsG: 14 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 47, proteinG: 0.9, fatG: 0.1, carbsG: 12 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 32, proteinG: 0.7, fatG: 0.3, carbsG: 7.7 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 57, proteinG: 0.7, fatG: 0.3, carbsG: 14 },
    allergenTags: [],
  ...
  // ── legumes / nuts ────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 76, proteinG: 8, fatG: 4.8, carbsG: 1.9 },
    allergenTags: ["soy"],
  ...
  },
  {
    ...
    per100g: { kcal: 588, proteinG: 25, fatG: 50, carbsG: 20 },
    allergenTags: ["peanut"],
  ...
  },
  {
    ...
    per100g: { kcal: 579, proteinG: 21, fatG: 50, carbsG: 22 },
  ...
  },
  {
    ...
    per100g: { kcal: 654, proteinG: 15, fatG: 65, carbsG: 14 },
    allergenTags: ["tree_nut"],
  ...
  // ── beverages ──────────────────────────────────────────────────────────
  {
    ...
    per100g: { kcal: 45, proteinG: 0.7, fatG: 0.2, carbsG: 10 },
    allergenTags: [],
  ...
  },
  {
    ...
    per100g: { kcal: 2, proteinG: 0.1, fatG: 0, carbsG: 0 },
    allergenTags: [],
